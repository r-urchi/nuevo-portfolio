...
const AboutMe = () => {
    ...
    return(
        <div className="section-container" id="about">
            ...
            Comencé a aprender sobre desarrollo como autodidacta en 2019. En 2020 me inscribí en la carrera de Desarrollador Front End en Coderhouse, donde tuve la oportunidad de reforzar conocimientos en Desarrollo Web utilizando HTML, Css, Sass, Git, Github. <br/> 
            ...
            En poco tiempo voy a estar comenzando con la parte de Back-End, donde voy a estar aprendiendo sobre Node.js. </p>
        </div>
    )
}
